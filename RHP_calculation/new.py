...
def calculate_RHP_values(file_path):
  ...
  try:
    ...
    filtered_columns = [   
        ...
        "P_SEMI_MAJOR_AXIS", "P_RADIUS", "P_MASS", "P_ECCENTRICITY", "P_FLUX",
        "P_TEMP_EQUIL", 'P_INCLINATION', "S_TYPE", "S_TEMPERATURE",
    ...
    for index, row in filtered_df.iterrows():
      if not math.isnan(row['P_MASS']) and not math.isnan(
        ...
        pl_orbsmax = row['P_SEMI_MAJOR_AXIS']
        ...
        pl_density, pl_gravity = row['P_DENSITY'], row['P_GRAVITY']
        ...
        #HB_r_i, HB_r_o = is_within_habitable_zone(pl_orbsmax, star_spect,
                                                  #sy_vmag, sy_dist)
        HB_r_i, HB_r_o = row['S_HZ_OPT_MIN'], row['S_HZ_OPT_MAX']

        ideal_ranges = {
            "eq_temp": (213, 313),  #around -60C to 40C
            "abs_solar_flux": (0.8, 0.6),
            "star_spectral": (["M", "G", "K"], ["F"]),
            "planet_type": (["Terrestrial", "SuperEarth"], ["Ice"]),
            "planet_gravity":
            (4.9, 29.4
          ...
          match param:
            ...
            case _:
              ...
              transform_const = -0.005 if (
                  param == "surf_temp" or param == "planet_gravity") else (
        ...
        new_row = [
            ...
            pl_orbsmax, pl_Erad, pl_Emass, pl_orbeccen, pl_insol, surf_temp,
        ...
        file_path = os.path.join('data_folder_6', st_name + '.csv')
        ...
        if os.path.exists(file_path):
          ...
          with open(file_path, mode='w', newline='') as file:
            ...
            writer.writerow([
                ...
                "pl_orbeccen", "pl_insol", "surf_temp", "pl_inclin", "pl_obliq",
        ...
        if str(probability) != 'nan':
          ...
          if (0.6 <= pl_Erad <= 1.4) and (0.6 <= pl_Emass <= 1.4) and (
            ...
            earth_like.append([
                ...
                pl_insol, surf_temp, pl_inclin, pl_obliq, pl_albedo, star_spect,
                st_teff, st_rad, st_mass, probability
            ])
          list_of_planets.append([pl_name, probability])
          habitable_probs_names.append(row['P_NAME'])
  ...
  #print(sorted_list)
  csv_file_name = os.path.join('data_folder_6', 'sorted_data.csv')
  ...
  csv_file_name = os.path.join('data_folder_6', 'earth_like.csv')
  with open(csv_file_name, 'w', newline='') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow([
